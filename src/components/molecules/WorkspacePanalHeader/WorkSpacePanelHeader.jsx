...
import { WorkspaceInviteModal } from '@/components/organisms/Auth/modals/WorkspaceInviteModal';
...
export const WorkspacePanelHeader = ({ workspace }) => {
  ...
  return (
    <>
      <WorkspaceInviteModal  joincode={workspace?.joinCode} openInvite={openInvite} setOpenInvite={setOpenInvite} />
